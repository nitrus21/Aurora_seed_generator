...
| --- | --- |
| **ESP32-2432S028R — Cheap Yellow Display (CYD)** | **1.9.5** et **1.7.5** |
...
CYD 1.9.5 : installer aussi la nouvelle table de partitions, incluse dans l’image fusionnée.
...
Les paquets GitHub sont séparés : `v1.9.5` pour le CYD et `v2.0.0` pour le P4.
...
- La 1.7.5 ne contient pas les corrections récentes : préférez la 1.9.5 sur CYD.
