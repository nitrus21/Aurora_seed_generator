...
$variants = @(
    @{ Id = 'cyd-1.9.5'; Manifest = 'manifest.json'; Chip = 'ESP32'; Image = 'aurora-1.9.5-esp32-2432s028r.factory.bin' },
...
Write-Output "PASS: CYD 1.9.5/1.7.5 and P4 2.0.0 (1.x/3.x): manifests, images, offsets, hashes and selection"
