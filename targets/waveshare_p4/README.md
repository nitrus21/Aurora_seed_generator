...
Le bouton d’information de l’accueil ouvre **À propos d’AURORA**. Cette page
affiche la version, le profil silicium et le SHA-256 de l’application réellement
installée, à comparer avec l’empreinte « SHA appareil » de la release officielle.
...
requis ni programmé par ce projet.
