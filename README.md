...
AURORA mélange le RNG matériel, les mouvements tactiles et les sources
disponibles : lumière sur CYD ; microphones et caméra OV5647 facultative sur P4.
Le CYD demande 320 échantillons. Le P4 2.0.12 demande 512 mouvements qualifiés,
environ 10 secondes d'activité et une couverture minimale de la zone ; un doigt
immobile ne fait pas progresser l'affichage.
...
PBKDF2-HMAC-SHA-256** pour les nouvelles sauvegardes ; le P4 2.0.12 en utilise
...
Depuis la 2.0.11, AURORA peut enregistrer cette récupération dans un fichier `.aurora` protégé
