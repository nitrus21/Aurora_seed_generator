...
| **Waveshare ESP32-P4-WIFI6-Touch-LCD-4.3** | Tactile capacitif 4,3″, 480 × 800 portrait ; 12 mots par page, grands QR et clavier sombre. | **2.0.11**, image adaptée au silicium **1.x** ou **3.x**. |
...
PBKDF2-HMAC-SHA-256** pour les nouvelles sauvegardes ; le P4 2.0.11 en utilise
...
La 2.0.11 peut enregistrer cette récupération dans un fichier `.aurora` protégé
